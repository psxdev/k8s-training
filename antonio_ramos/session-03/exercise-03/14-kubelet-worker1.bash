...
scp $KUBELET_CSR_PATH ubuntu@$CONTROLLER0_PUBLIC_IP:/tmp/
scp $KUBELET_CERT_CONFIG ubuntu@$CONTROLLER0_PUBLIC_IP:/tmp/
...
scp ubuntu@$CONTROLLER0_PUBLIC_IP:$KUBELET_CERT_OUT_PATH "$KUBELET_CERT_PATH"
scp ubuntu@$CONTROLLER0_PUBLIC_IP:$KUBERNETES_CA_CERT_PATH "$KUBERNETES_CA_CERT_PATH"
...
#
kubectl config set-cluster k8s-training --certificate-authority=$KUBERNETES_CA_CERT_PATH --embed-certs=true --server=https://${CONTROLLER1_PRIVATE_IP}:6443 --kubeconfig=${KUBELET_KUBECONFIG_PATH}
