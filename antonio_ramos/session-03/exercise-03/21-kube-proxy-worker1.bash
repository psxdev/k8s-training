...
#scp $KUBE_PROXY_CSR_PATH ubuntu@$CONTROLLER0_PUBLIC_IP:/tmp/
...
#
kubectl config set-cluster k8s-training --certificate-authority=$KUBERNETES_CA_CERT_PATH --embed-certs=true --server=https://${CONTROLLER1_PRIVATE_IP}:6443 --kubeconfig=${KUBE_PROXY_KUBECONFIG_PATH}
